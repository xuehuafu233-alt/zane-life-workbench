...
- [dontbesilent2025/dbskill](https://github.com/dontbesilent2025/dbskill)：参考以用途、场景、起步输入和方法手册组织公开产品的方式。Inspired the organization of public documentation around use cases and practical starting points.
- [values-card-sort](https://github.com/drjennyshields/values-card-sort/tree/414a6eb727f8d3720645bbe5d6f37117121abe13)：价值探索与现实反思。Values exploration and reflection on lived experience.
